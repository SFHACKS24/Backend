...
def create_app(db_url=None):
    app=Flask(__name__) #file name has to match the variable name
...
# other way: http://127.0.0.1:5000/store?name=My Store
# To run the folder allowing change in code to be running.
